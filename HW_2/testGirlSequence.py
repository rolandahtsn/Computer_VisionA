...
def updatefig(i, plot_idx = [0, 19, 39, 59, 79]):
    ...
    # print(i,'< i')    
    if i:
        plt.savefig("./result2/tracking_1_3_girls_" + str(i) + ".png", bbox_inches='tight', pad_inches=0)
...
plot_idx = [0, 19, 39, 59, 79]
for i in range(5):
    axarr[i].imshow(plt.imread(f"result2/tracking_1_3_girls_" + str(plot_idx[i]) + ".png"))
...
#load 10 images
for i in range(90):
    data = imageio.imread(f"result2/tracking_1_3_girls_" + str(i) + ".png")
